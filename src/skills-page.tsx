...
import type { Role, SkillDoc, SkillSource } from './lib/profile-api';
...
export function SkillsPage({ profileId, profileName, skills: initialSkills, roles, agentSkills, gateway, createSkill, run, skillDocs = [], removeSkillDoc }: {
  ...
  skillDocs?: SkillDoc[]; removeSkillDoc?: (name: string) => Promise<void>;
}) {
